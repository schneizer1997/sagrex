            ...
            <a class="nav-link dropdown-toggle" href="#">
              ...
              <div id="content-wrapper">
                ...
                <div class="container-fluid">
                  ...
                  <div class="card-header"><p>Accounting Systems</div>
                            ...
                            <div class="card-body">
                              ...
                              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                <thead>
                                  ...
                                  <tr>
                                    <th><a href="accounts.php" id="">Accounts</a></th>

                                    <th>Create and Edit Request</th>
                                  </tr>
                                  <!-- <tr>
                                    <th><a href="#" id="">Customer Profile</a></th>

                                    <th>Create and Edit Request</th>
                                  </tr>
                                  <tr>
                                    <th><a href="#" id="">Salesman</a></th>

                                    <th>Create and Edit Request</th>
                                  </tr> -->
                                  <tr>
                                    <th><a href="salesbook.php" id="">Sales Book</a></th>

                                    <th>Create and Edit Request</th>
                                  </tr>
                                  <tr>
                                    <th><a href="#" id="">Cash Receipt Book</a></th>
                                    <th>Update Credentials</th>
                                  </tr>
                                  <tr>
                                    <th><a href="#" id="">Cash Disbursement Book</a></th>
                                    <th>Check Materials Requested</th>
                                  </tr>

                                  <tr>
                                    <th><a href="#">Journal Voucher Book</a></th>
...
<div class="btn-group">
  ...
  <div id="dropselect-demo1" class="dropdown-menu">
    <a class="dropdown-item" href="#">Action</a>
    <a class="dropdown-item" href="#">Another action</a>
    <a class="dropdown-item" href="#">Something else here</a>
    <div class="dropdown-divider"></div>
