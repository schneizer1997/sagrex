...
<head>
  ...
  <link href="../../../vendor/bootstrap/css/hierarchy-select.min.css" rel="stylesheet">
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="../accounting_main.php">
                ...
                <div id="content-wrapper">
                  ...
                  <div class="container-fluid">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                      <li class="nav-item">
                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">CHECK INFO TABLE</a>
                      </li>
                      <!-- <li class="nav-item">
 ...
 -->
              ...
              <script src="../../../js/src/toword.js" type="text/javascript"></script>
              <script src="../../../vendor/bootstrap/js/jquery.num2words.js" type="text/javascript"></script>
              <script src="../../../vendor/bootstrap/js/hierarchy-select.js" type="text/javascript"></script>
              <script src="../../../vendor/bootstrap/js/hierarchy-select.min.js" type="text/javascript"></script>
