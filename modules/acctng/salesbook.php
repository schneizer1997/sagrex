...
<head>
  ...
  <link href="../../vendor/bootstrap/css/bootstrap-dropselect.css" rel="stylesheet">
            ...
            <a class="nav-link dropdown-toggle" href="#">
              ...
              <div id="content-wrapper">
                ...
                <div class="container-fluid">
                  ...
                  <div class="card-header"><p>Sales Book</div>
                    
                    <div class="card-header">
                      <div class="row">
                      <div class="col-sm-6" style="border:1px;">
                      <div class="form-group row">
                            <label class="col-sm-5 col-form-label" id="" style="height: 30px;">Invoice No. :</label>
                            <div class="col-sm-7">
                              <input type="text" class="form-control" id="txtinvoice" placeholder="" style="height: 30px;">
                            </div>
                      </div>
                      <div class="form-group row">
                            <label class="col-sm-5 col-form-label" id="" style="height: 30px;">Date :</label>
                            <div class="col-sm-7">
                              <input type="date" class="form-control" id="txtsalesdate" placeholder="" style="height: 30px;">
                            </div>
                      </div>
                      <div class="form-group row">
                            <label class="col-sm-5 col-form-label" id="" style="height: 30px;">Invoice Type :</label>
                            <div class="col-sm-7">
                      ...
                      <div class="form-group row">
                            <label class="col-sm-5 col-form-label" id="" style="height: 30px;">Customer :</label>
                            <div class="col-sm-7">
                              <input type="text" class="form-control" id="txtcustomer" placeholder="" style="height: 30px;">
                            </div>
                      </div>
                      <div class="form-group row">
                            <label class="col-sm-5 col-form-label" id="" style="height: 30px;">Salesman :</label>
                            <div class="col-sm-7">
                              <input type="text" class="form-control" id="txtsalesman" placeholder="" style="height: 30px;">
                            </div>
                      </div>
                      </div>
                      <div class="col-sm-6" style="">
                        <div class="form-group row">
                            <label class="col-sm-5 col-form-label" id="" style="height: 30px;">Amount :</label>
                            <div class="col-sm-6">
                              <input type="text" class="form-control" id="txtamount" placeholder="" style="height: 30px;">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-5 col-form-label" id="" style="height: 30px;">Particulars :</label>
                            <div class="col-sm-6">
                              <textarea class="form-control" id="txtparticulars">dsds</textarea>
                            </div>
                        </div>
                        <br>
            ...
            <div class="wew" id = "dsd">
              ...
              <tr>
                <td colspan="2">Action:Causes<br><br>
                  ...
                  <div class="form-group row">
                    <label for="inputPassword" class="col-sm-2 col-form-label" style="height: 30px;">Corrective
                    </label>
                    <div class="col-sm-10">
...
<script src="../../vendor/bootstrap/js/bootstrap-dropselect.js"></script>
