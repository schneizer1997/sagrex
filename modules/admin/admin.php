                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                      <thead>
                                        ...
                                        <tr>
                                          ...
                                          <th>
                                            <ul>
                                              <li><a href="purchasing_sys/vam_item.php">Purchased Item</a><br></li>
                                              <li><a href="purchasing_sys/vam_rms.php">Repairs/Machining/Servicing</a></li>
                                            </ul>
                                        ...
                                        <tr>
                                          ...
                                          <th>
                                            <ul>
                                              <li><a href="purchasing_sys/fuel_main.php">View Fuels</a><br></li>
