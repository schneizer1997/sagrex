                ...
                <div id="content-wrapper">
                  ...
                  <div class="container-fluid">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                      <li class="nav-item">
                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Employee's Info</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">RR and SIS (New Item)</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#sisinfo" role="tab" aria-controls="sisinfo" aria-selected="false">Search SIS</a>
                      </li>
                      <li class="nav-item">
                    ...
                    <div class="tab-content" id="myTabContent">
                      <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <?php
                        //include('tables/empinfo_load.php');
                        ?>
                      </div>
                      ...
                      <div class="tab-pane fade" id="sisinfo" role="tabpanel" aria-labelledby="sisinfo-tab">
                        <?php
                        //include('sis_tabcontent.php');
                        ?>

                      </div>
                      <div class="tab-pane fade" id="items" role="tabpanel" aria-labelledby="contact-tab">
                        <?php
