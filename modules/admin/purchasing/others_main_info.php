      ...
      <div class="table-responsive">
        ...
        <table class="table table-hover" id="tblproditem" width="100%" cellspacing="0">
          <thead>
            ...
            <tbody>
              <?php
              include('tables/others_main_table.php');
              ?>
            </tbody>
...
*/
                   ...
                   $('#btnsaveasitem').click(function(){
                    ...
                    if (desig == "" || item == "" || daterefno == ""){
                      ...
                      xajax_insertothersitem(desig,item,descr,brand,purp,qty,unit,price,amount,supp_name,supp_addr,rf_no,daterfno,po_no,po_date,req_by,ref_no,daterefno,cvjv,pjd,other_ref,remarks);
                  ...
                  $('#btnprintreport').click(function(){
                    ...
                    if (val == ''){
                      ...
                      window.open("../../../reports/others_report.php?datefrom= " + from + " & dateto="+to+" & designation="+val.toString(), "_blank");
...
/*                  $(document).ready(function() {*/
  //$('#tblproditem').DataTable();
/*  var table = $('#tblproditem').DataTable();
    $('#tblproditem tr').on('click', 'td', function () {
      var data = table.row( this ).data();
      alert('sds');
      //alert( 'You clicked on '+data[1]+'\'s row' );
  });
});*/
                /*  $('#tblproditem tbody').on( 'click', 'button', function () {
        var data = table.row( $(this).parents('tr') ).data();
        alert( data[0] +"'s salary is: "+ data[ 5 ] );
    } );*/
    

              /*    $('#tblproditem').on('click', 'tbody tr', function() {
   ...
   /* footerCallback: function( tfoot, data, start, end, display ) {
    ...
    initComplete: function () {
            ...
            this.api().columns(1).every( function () {
                ...
                var column = this;
                var select = $('<select id = "cbocategory" style = "width:100px;" ><option value=""></option><option value="CUSTOMERS">CUSTOMERS</option><option value="AFFILIATES">AFFILIATES</option><option value="SALES PERSONNEL">SALES PERSONNEL</option></select>')
...
xajax_updateinfoitem(vamitemid,$('#txtdesignation').val(),$('#txtitem').val(),$('#txtdesc').val(),$('#txtbrand').val(),$('#txtpurpose').val(),$('#txtqty').val(),$('#txtunit').val(),$('#txtprice').val(),$('#txtamount').val(),$('#txtsupp').val(),$('#txtaddr').val(),$('#txtrfno').val(),$('#txtdaterfno').val(),$('#txtpono').val(),$('#txtponodate').val(),$('#txtreqby').val(),$('#txtrefno').val(),$('#txtdaterefno').val(),$('#txtref').val(),$('#txtpjd').val(),$('#txtotherref').val(),$('#txtremark').val());
swal.fire({
    title: "UPDATE!",
