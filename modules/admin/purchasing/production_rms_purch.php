  ...
  <div class="card mb-3">
    ...
    <div class="card-body">
      <div class="table-responsive">
        ...
        <table class="table table-hover" id="tblproditemrms" width="100%" cellspacing="0">
          <thead>
            ...
            <tbody>
              <?php
              include('tables/production_rms_purch_table.php');
              ?>
            </tbody>
                  ...
                  <div id="leftmat" style="border: 1px;min-width: 600px;float: left;">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        ...
                        <!-- <textarea type="text" class="form-control" id="txtrepairtype" placeholder="" style="height: 30px;"></textarea> -->
...
window.location.reload();
                    ...
                    //$('#tblproditemrms').DataTable().destroy();
                    //$('#tblproditemrms').empty();
                    /*$('#tblproditemrms').DataTable().destroy();
                    $('#tblproditemrms').find('tbody').append("<tr><td></td><td></td></tr>");
                    $('#tblproditemrms').DataTable().draw();*/
                    //var table = $('#tblproditemrms').DataTable();
                    /*var myDataTable = $("#my-datatable").html("<table><thead></thead><tbody></tbody></table>");
                    $("#tblproditemrms",myDataTable).DataTable({});*/
                    ...
                    /*const table=$("#tblproditemrms").dataTable();
                    table.fnPageChange("first",1);*/
                    /*var table = $('#tblproditemrms').DataTable();
//var tr = $('#tblproditemrms tbody tr:eq(0)');
...
*/
                   ...
                   $('#btnsaveitem').click(function(){
                    ...
                    if (desig == "" || item == "" || daterefno == ""){
                      ...
                      xajax_insertproditemrms(desig,item,descr,brand,purp,qty,unit,price,amount,supp_name,supp_addr,rf_no,daterfno,po_no,po_date,req_by,ref_no,daterefno,cvjv,pjd,other_ref,remarks);
                  ...
                  $('#btnprintreport').click(function(){
                    ...
                    if (val == ''){
                      ...
                      window.open("../../../reports/prod_rms_report.php?datefrom= " + from + " & dateto="+to+" & designation="+val.toString(), "_blank");
...
/*                  $(document).ready(function() {*/
  //$('#tblproditemrms').DataTable();
/*  var table = $('#tblproditemrms').DataTable();
    $('#tblproditemrms tr').on('click', 'td', function () {
      var data = table.row( this ).data();
      alert('sds');
      //alert( 'You clicked on '+data[1]+'\'s row' );
  });
});*/
                /*  $('#tblproditemrms tbody').on( 'click', 'button', function () {
        var data = table.row( $(this).parents('tr') ).data();
        alert( data[0] +"'s salary is: "+ data[ 5 ] );
    } );*/
    

              /*    $('#tblproditemrms').on('click', 'tbody tr', function() {
...
*/
var val ="";
if ( $.fn.dataTable.isDataTable( '#tblproditemrms' ) ) {
    /*var table = $('#tblproditemrms').DataTable();
    alert("adads");*/
  }
  else {
  //alert("adad");
  $(document).ready(function() {
    $('#tblproditemrms tfoot th').each( function (i) {
            var title = $(this).text();
...
$('#tblproditemrms tfoot th').each( function () {
  var title = $(this).text();
...
$('#tblproditemrms tbody').on('dblclick','tr',function(e){

  var currentRow = $(this).closest("tr");

  var data = $('#tblproditemrms').DataTable().row(currentRow).data();
    //alert(data['1']);
...
xajax_updateproditemrms(vamitemid,$('#txtdesignation').val(),$('#txtrepairtype').val(),$('#txtdesc').val(),$('#txtbrand').val(),$('#txtpurpose').val(),$('#txtqty').val(),$('#txtunit').val(),$('#txtprice').val(),$('#txtamount').val(),$('#txtsupp').val(),$('#txtaddr').val(),$('#txtrfno').val(),$('#txtdaterfno').val(),$('#txtpono').val(),$('#txtponodate').val(),$('#txtreqby').val(),$('#txtrefno').val(),$('#txtdaterefno').val(),$('#txtref').val(),$('#txtpjd').val(),$('#txtotherref').val(),$('#txtremark').val());
