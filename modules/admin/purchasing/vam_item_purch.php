              ...
              <!-- <form action="" method="GET" enctype="multipart/form-data"> -->
                <div style="border: 1px;min-height: 100px;min-width:300px;line-height: 50px;margin: 10px;">
                  <div id="leftmat" style="border: 1px;min-width: 600px;float: left;">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" id="txtitem" placeholder="" style="height: 30px;" >
                      </div>
                    </div>
                    <div class="form-group row">
                ...
                <script type="text/javascript">
                  ...
                  $('#btnprintreport').click(function(){
                    ...
                    if (tfplatenos == ''){
                      window.open("../../../reports/vam_item_report.php?datefrom= " + from + " & dateto="+to+" & plateno="+tfplatenos, "_blank"); 
                    }
                    else if(tfplatenos != '') {
                      window.open("../../../reports/vam_item_specific.php?datefrom= " + from + " & dateto="+to+" & plateno="+tfplatenos, "_blank");
...
$('#tblitempurch tbody').on('dblclick','tr',function(e){
  ...
  vamitemid = rowid;
  plate_id = rowplateid;
  //alert('rowplateid'+ rowplateid + 'vamitemid' + vamitemid );
...
$('#btnupdateitem').click(function(){
  if (plate_id != ''){
    xajax_updateitemvam(plate_id,vamitemid,$('#txtassign').val(),$('#txtitem').val(),$('#txtdesc').val(),$('#txtbrand').val(),$('#txtqty').val(),$('#txtunit').val(),$('#txtprice').val(),$('#txtamount').val(),$('#txtsupp').val(),$('#txtaddr').val(),$('#txtrfno').val(),$('#txtdaterfno').val(),$('#txtpono').val(),$('#txtponodate').val(),$('#txtreqby').val(),$('#txtrefno').val(),$('#txtdaterefno').val(),$('#txtref').val(),$('#txtotherref').val(),$('#txtremark').val(),1);
  }
  else {
    xajax_updateitemvam(rowplateid,vamitemid,$('#txtassign').val(),$('#txtitem').val(),$('#txtdesc').val(),$('#txtbrand').val(),$('#txtqty').val(),$('#txtunit').val(),$('#txtprice').val(),$('#txtamount').val(),$('#txtsupp').val(),$('#txtaddr').val(),$('#txtrfno').val(),$('#txtdaterfno').val(),$('#txtpono').val(),$('#txtponodate').val(),$('#txtreqby').val(),$('#txtrefno').val(),$('#txtdaterefno').val(),$('#txtref').val(),$('#txtotherref').val(),$('#txtremark').val(),1);
  }
