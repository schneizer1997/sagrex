<?php
	...
	//Load Cancelled request based on dates
	global $db;
	$from = $_GET['from'];
	$to = $_GET['to'];
	...
	$sql = "SELECT  *FROM tblrequestform WHERE DateAdded BETWEEN '".$from."' AND  '".$to."' AND MWRFStatus = 'CANCELLED' AND isdelete = 1";
	...
	if ($result->num_rows > 0 ){
		...
		$cancelcount = $result->num_rows;
		echo "<input type = 'hidden' name = 'txtcancelcount' id = 'txtcancelcount' value='$cancelcount'>";
/*}
*/
?>
<!DOCTYPE html>
