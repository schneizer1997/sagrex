<?php
	...
	//Load Completed request based on dates
	global $db;

	$from = $_GET['from'];
	$to = $_GET['to'];

	$sql = "SELECT  *FROM tblrequestform WHERE DateAdded BETWEEN '".$from."' AND  '".$to."' AND MWRFStatus = 'COMPLETED' AND isdelete = 1";
	...
	if ($result->num_rows > 0 ){
		...
		echo "<input type = 'hidden' name = 'txtcompletecount' id = 'txtcompletecount' value='$completecount'>";
