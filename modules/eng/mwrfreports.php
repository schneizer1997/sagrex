    ...
    <div class="card-body">
      <div class="table-responsive">
        <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
          <thead>
            <tr>
              <th style = "min-width:200px;">MWRFID</th>
            ...
            <div style="height:0px;min-width:500px;margin-right:2px;">
              <table class="table table-bordered" id="mtable1" cellspacing="0">
                ...
                <tbody id="mtable2">
                  ...
                  <iframe style="border: 0px;height: 500px;" name="framemat" id="framemat" src="../../reports/mwrf_new.php" /></iframe>
                </tbody>
              </table>
            </div>
  ...
  <div class="modal fade bd-example-modal-lg" id="editrequestmodal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    ...
    <script type="text/javascript">
      ...
      function loadreportpdf(mwrfid,MWRFNo,rt,pn,wt,wv,jc,rept,pt,it,bt,ctd,tf,df,pd,pc,ca,pa,remarks,rb,dhm,d1,d2,d3,st,sd,ft,fd,rrb,rab,tor,tmh,wcb,rrno,ms,requestor,cmvb,da,de){
        ...
        document.getElementById("framemat").src = '../../reports/mwrf_new.php?mwrfid1=' + mwrfid+"&"+"mwrfno="+MWRFNo+"&"+"rt="+rt+"&"+"pn="+pn+"&"+"wt="+wt+"&"+"wv="+wv+"&"+"jc="+jc+"&"+"rept="+rept+"&"+"pt="+pt+"&"+"it="+it+"&"+"bt="+bt+"&"+"ctd="+ctd+"&"+"tf="+tf+"&"+"df="+df+"&"+"pd="+pd+"&"+"pc="+pc+"&"+"ca="+ca+"&"+"pa="+pa+"&"+"remarks="+remarks+"&"+"rb="+rb+"&"+"dhm="+dhm+"&"+"d1="+d1+"&"+"d2="+d2+"&"+"d3="+d3+"&"+"st="+st+"&"+"sd="+sd+"&"+"ft="+ft+"&"+"fd="+fd+"&"+"rrb="+rrb+"&"+"rab="+rab+"&"+"tor="+tor+"&"+"tmh="+tmh+"&"+"wcb="+wcb+"&"+"rrno="+rrno+"&"+"ms="+ms+"&"+"requestor="+requestor+"&"+"cmvb="+cmvb+"&"+"da="+da+"&"+"de="+de;
