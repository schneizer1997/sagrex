                ...
                <div id="content-wrapper">
                  ...
                  <div class="container-fluid">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">SINGLE ITEMS</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#sisinfo" role="tab" aria-controls="sisinfo" aria-selected="false">PACKAGE ITEMS</a>
                      </li>
                      <li class="nav-item">
