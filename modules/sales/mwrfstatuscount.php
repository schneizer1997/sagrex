...
<body id="page-top">
  ...
  <div class="row" style="border: 1px solid grey;">
    <div class="col-sm-1">
      ...
      <input type="" name="txtpending" id="txtpending" class="form-control" disabled>
    </div>
    <div class="col-sm-1">
      <label style="color: green;">COMPLETED:</label>
      <input type="" name="txtcompleted" id="txtcompleted" class="form-control" disabled>
      <label></label>
    </div>
...
<form action="mwrfpendingload.php" method="GET" enctype="multipart/form-data">
  ...
  <div class="row" style="background-color: #dad8d8;">
    <div class="form-group row" style="margin-left: 10px;">
      ...
      <label class="col-form-label" style="color: blue;">Total Records of Pending/Completed:</label>
      <div class="col-sm-2">
    ...
    <script type="text/javascript">
      ...
      $('#framematpend').on('load', function(){
        ...
        var totalrec = parseInt(pend) + parseInt(comp);
