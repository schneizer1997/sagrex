            ...
            <li class="nav-item dropdown">
              ...
              <div id="content-wrapper">
                ...
                <div class="container-fluid">
                  ...
                  <div class="card-header"><p>Sales Systems</div>
                            ...
                            <div class="card-body">
                              ...
                              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                <thead>
                                  ...
                                  <tr>
                                    <th><a href="mwrfreports.php">MWRF[CLOSED]</a></th>
                                    <th>Print Reports of Request Forms</th>
                                  </tr>
...
xajax_addrequestmaterial(mwrf,mat,qty,0,"",sdate,1,1,"dsd",1321,2,"","",1,
  1);
    ...
    $('#btnauthenticatemain').click(function(){
      $('#txtusermain').val("maintenance");
      $("#loginmaintenancemodal").modal('show');
    });
    $('#btnauthenticatepur').click(function(){
      $('#txtusermain').val("purchasing");
      $("#loginmaintenancemodal").modal('show');
    });
    $('#btnauthenticateware').click(function(){
