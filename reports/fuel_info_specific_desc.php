...
/*include_once ('PHPJasperXML-master/PHPJasperXML-master/setting.php');*/
...
$PHPJasperXML->arrayParameter=array("platenumber"=>"'".$platenos."'","descr"=>"'".$descr."'","datefrom"=>$appenddatefrom,"dateto"=>$appenddateto,"datefromrange"=>$appenddatefromrange,"datetorange"=>$appenddatetorange);
$xml = simplexml_load_file("fuel_report_specific_desc.jrxml");
/*if ($platenos != ' '){
