...
$PHPJasperXML->arrayParameter=array("datefrom"=>$appenddatefrom,"dateto"=>$appenddateto,"datefromrange"=>$appenddatefromrange,"datetorange"=>$appenddatetorange,"descr"=>"'".$descr."'");
$xml = simplexml_load_file("fuel_report.jrxml");
/*if ($platenos != ' '){
