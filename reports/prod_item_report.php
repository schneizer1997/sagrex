...
$PHPJasperXML->arrayParameter=array("datefrom"=>$appenddatefrom,"dateto"=>$appenddateto,"datefromrange"=>$appenddatefromrange,"datetorange"=>$appenddatetorange,"designation"=>"'".$designation."'");
$xml = simplexml_load_file("prod_item_report.jrxml");
/*if ($platenos != ' '){
