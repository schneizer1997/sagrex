...
$PHPJasperXML->arrayParameter=array("datefrom"=>$appenddatefrom,"dateto"=>$appenddateto,"datefromrange"=>$appenddatefromrange,"datetorange"=>$appenddatetorange);
$xml = simplexml_load_file("vam_item_report.jrxml");
/*if ($platenos != ' '){
