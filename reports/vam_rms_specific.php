...
$PHPJasperXML->arrayParameter=array("platenumber"=>"'".$platenos."'","datefrom"=>$appenddatefrom,"dateto"=>$appenddateto,"datefromrange"=>$appenddatefromrange,"datetorange"=>$appenddatetorange);
$xml = simplexml_load_file("vam_rms_report_specific.jrxml");
/*if ($platenos != ' '){
